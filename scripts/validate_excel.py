...
from yanjia_automation.excel.workbook import ExcelCaseRepository, WorkbookFormatError
...
def main() -> int:
    ...
    try:
        ...
        variables = VariableResolver.from_settings(settings, run_id="VALIDATION")
